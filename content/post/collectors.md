...
![经典垃圾收集器](http://localhost:1313/blogs/collectors.png)
...
![serial垃圾收集器](http://localhost:1313/blogs/serial.png)
...
![parnew垃圾收集器](http://localhost:1313/blogs/parnew.png)
...
![serialold垃圾收集器](http://localhost:1313/blogs/serial.png)
...
![parallelold垃圾收集器](http://localhost:1313/blogs/parallelold.png)
...
![cms垃圾收集器](http://localhost:1313/blogs/cms.png)
...
![g1垃圾收集器](http://localhost:1313/blogs/g1.png)
...
`G1`收集器运行示意图如下：
![g1垃圾收集器](http://localhost:1313/blogs/g1pic.png)
